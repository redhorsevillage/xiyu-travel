...
| 🌊 海天奇景 | **12 個景點**（跨海大橋・通樑古榕・鯨魚洞・夢幻沙灘・二崁聚落・大菓葉玄武岩・池西岩瀑・小池角雙曲橋・赤馬沙灘・內垵沙灘・漁翁島燈塔・三仙塔），採 **Wikimedia 實景照片** + 點擊燈箱看故事 |
| 🦪 鹹鮮風味 | **9 道在地美食**翻轉木牌（仙人掌冰・小管麵線・大池炸粿・二崁杏仁茶・小池角豆花・枕頭餅・阿綢炸粿・海港海鮮・外垵刈包），背面附推薦店家 |
| 🗺️ 探活踩風 | **內嵌 Google Maps**：點站即時定位 + 一鍵多點導航（半日遊／一日遊） |
| ✉️ 寄情明信片 | HTML5 Canvas：3 款背景、4 種手繪貼紙可拖曳/縮放/刪除（支援觸控）、思源宋體/黑體字體、下載 PNG |
...
字體：`Noto Serif TC`（標題・思源宋體）、`Noto Sans TC`（內文・思源黑體）。
...
- **v4 古樸漁港**（現行）：weathered 復古美學 + Google 地圖整合 + Wikimedia 真實影像
  - 海天奇景擴充至 **12 個景點**（4×3，依地理動線排序），全數配上免費授權實景照片
  - 鹹鮮風味改為 **9 道在地美食**（每排三種）並標註推薦店家
  - 探活踩風以**內嵌 Google Maps** 取代自繪 SVG 地圖：點站即時定位 + 半日／一日遊一鍵多點導航
  - 明信片字體改為思源宋體／黑體，精簡背景與貼紙，並修正寄語無法顯示的問題
  - 補上 MIT `LICENSE`、第三方授權 `NOTICE.md`，清理 dead code
