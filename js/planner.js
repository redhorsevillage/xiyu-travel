...
(function () {
  ...
  const ROUTES = {
    half: {
      label: '半日遊',
      stops: [
        { t: '09:00', name: '通梁古榕',         q: '通梁古榕 澎湖',         nav: '通梁古榕',         desc: '三百年古榕與保安宮，跨橋前的暖身第一站。' },
        { t: '09:40', name: '澎湖跨海大橋',     q: '澎湖跨海大橋',         nav: '澎湖跨海大橋',     desc: '跨越吼門水道，正式踏上漁翁島西嶼。' },
    ...
    full: {
      label: '一日遊',
      stops: [
        { t: '09:00', name: '通梁古榕',         q: '通梁古榕 澎湖',         nav: '通梁古榕',         desc: '三百年古榕與保安宮，環島起點。' },
        { t: '09:30', name: '澎湖跨海大橋',     q: '澎湖跨海大橋',         nav: '澎湖跨海大橋',     desc: '跨越吼門水道進入西嶼。' },
